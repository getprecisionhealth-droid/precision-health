  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'rounded-xl border border-[#27272a] bg-[#111113] shadow-2xl shadow-black/50 p-6',
        'data-[state=open]:animate-in data-[state=closed]:animate-out',
        'data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
    ...
    >
      {children}
      {showClose && (
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 text-[#71717a] hover:opacity-100 hover:text-[#fafafa] transition-opacity">
          <X className="h-4 w-4" />
